...
3. Habilitar **Google**:
   ...
   - A�adir redirect URL: `https://tu-proyecto.supabase.co/auth/v1/callback`
...
En **Settings > Secrets and variables > Actions**, a�adir:
...
Aseg�rate de que `.env` existe y contiene las variables correctas.

### OAuth redirect no funciona

1. Verificar que la URL est� en **Redirect URLs** de Supabase
...
Verificar que las pol�ticas RLS permiten acceso a usuarios autenticados:
